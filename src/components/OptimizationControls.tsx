...
export const OptimizationControls = ({
  ...
  return (
    <div className='sticky bottom-4 z-40 mt-8 p-4 rounded-2xl border border-brand-purple bg-brand-purple/5 dark:border-white/10 dark:bg-white/5 backdrop-blur-xl flex flex-wrap items-center justify-between gap-4 max-w-4xl mx-auto shadow-2xl shadow-brand-purple/5 dark:shadow-brand-purple/20'>
